...
const headCells: HeadCell[] = [
    ...
    {id: 'endereco', numeric: true, disablePadding: false, label: 'Endereço'},
];

interface EnhancedTableProps {
    classes: ReturnType<typeof useStyles>;
    numSelected: number;
    onRequestSort: (event: React.MouseEvent<unknown>, property: keyof Contato) => void;
...
function EnhancedTableHead(props: EnhancedTableProps) {
    ...
    const createSortHandler = (property: keyof Contato) => (event: React.MouseEvent<unknown>) => {
...
export default function EnhancedTable(props: any) {
    ...
    const rows: Contato[] = props.data;
    const classes = useStyles();
    const [order, setOrder] = React.useState<Order>('asc');
    const [orderBy, setOrderBy] = React.useState<keyof Contato>('nome');
    const [selected, setSelected] = React.useState<number[]>([]);
    const [page, setPage] = React.useState(0);
    const [dense, setDense] = React.useState(false);
    const [rowsPerPage, setRowsPerPage] = React.useState(5);

    const handleRequestSort = (event: React.MouseEvent<unknown>, property: keyof Contato) => {
                                        ...
                                        >
                                            ...
                                            <TableCell align="right">
                                                <IconButton aria-label="delete"
                                                            onClick={() => props.deleteAction(row.id)}>
                                                    <DeleteIcon/>
                                                </IconButton>
                                                <IconButton aria-label="delete"
